...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{system_compare.png}
...
\begin{algorithmic}[1]
\Function{Partition}{$P_i, block_table$} \Comment{block_table is the set of graph blocks owned by graph partition $P_i$.}
